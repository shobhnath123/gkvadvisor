...
class Bucket {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const metaData = (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.metaData)
                ? Object.entries(uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.metaData)
                    ...
                    .join('')
                : '';
            const headers = Object.assign({ compress: 'false', 'Content-Type': contentType ? contentType : 'application/octet-stream', 'expires-after': (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.ttl) || '', overwrite: (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.overwrite) || '' }, (metaData ? { 'x-user-meta': metaData } : {}));
            const param = {
                extractAndUpload: (uploadOptions === null || uploadOptions === void 0 ? void 0 : uploadOptions.extractUpload) || ''
            };
            const signParam = (yield __classPrivateFieldGet(this, _Bucket_util, "f").getBucketSignature());
            if (signParam !== undefined) {
                url += '/_signed';
     ...
     */
    uploadPart(key, uploadId, body, partNumber, overwrite = 'false') {
        return __awaiter(this, void 0, void 0, function* () {
            if (body instanceof Buffer) {
                body = stream_1.Readable.from(body);
            }
