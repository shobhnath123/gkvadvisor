...
import { IStratusObjects, IStratusBucket, IStratusCorsRes, IStratusObjectDetails, IStratusPagedObjectOptions, IStratusPreSignedUrlOptions, IStratusPutObjectOptions, IStratusUnzipRes, IStratusObjectRenameRes, IStratusMultipartSummaryRes, IStratusInitiateUpload, IStratusUnzipStatus, IStratusObjectCopyRes } from '../utils/pojo/stratus';
...
export declare class Bucket {
     ...
     * ```
     * @returns { boolean } Indicating whether the upload was successful (`true` if successful, `false` if failed).
     */
    putObject(key: string, body: Stream | Buffer | string, uploadOptions?: IStratusPutObjectOptions): Promise<boolean>;
    /**
     ...
     */
    initiateMultipartUpload(key: string): Promise<IStratusInitiateUpload>;
    /**
     ...
     */
    uploadPart(key: string, uploadId: string, body: Stream | Buffer, partNumber: number, overwrite?: string): Promise<boolean>;
    /**
