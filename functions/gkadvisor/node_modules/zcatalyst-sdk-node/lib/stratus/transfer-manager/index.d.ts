...
export declare class TransferManager {
     ...
     */
    getIterableObject(key: string, partSize: number): AsyncGenerator<Buffer, void>;
    /**
     ...
     */
    generatePartDownloaders(key: string, partSize: number): Promise<Array<() => Promise<Readable>>>;
}
