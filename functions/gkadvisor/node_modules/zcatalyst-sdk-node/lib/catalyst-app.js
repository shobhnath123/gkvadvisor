        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.credential instanceof credential_1.CatalystCredential ||
                ...
                if ((0, validator_1.isNonEmptyString)(token.access_token)) {
                    ...
                    if (this.tokenOnly && this.config) {
                        if (!this.tempCredential) {
                            this.tempCredential = new credential_1.JwtTokenCredential(Object.assign({ cookie: token.cookie }, this.config));
                        }
...
class CatalystApp extends CatalystAppInternals {
    ...
    ensureService(serviceName, initializer, override = false, tokenOnly = false) {
        let service;
